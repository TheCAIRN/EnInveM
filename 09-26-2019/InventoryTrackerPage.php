  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h2 class="modal-title" id="exampleModalLabel"> <i style="color:#FFC222;" class="fas fa-shopping-cart"></i> Shopping Cart</h2>
	...
	<div class="container container-fluid col-12">
		<div class="row float-right">
			<div class="col-12 float-right">
				<button class="btn btn-dark" data-toggle="modal" data-target="#ShoppingCart"><i style="color:#FFC222;" class="fas fa-shopping-cart fa-2x"></i></button>
			</div>
		</div>
	</div>
	<br>
			...
			<form class="w-100" method="POST" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<div class="input-group">
				  ...
				  <div class="input-group-append">
				    <button type="submit" class="input-group-text btn btn-dark" id="SearchButton" name="searchInventory"><i style="color:#FFC222"; class="fas fa-search"></i>&nbsp Search</button>
				  </div>
				</div>
			</form>
			</div>
...
<br>
		...
		<button class="btn btn-dark" name="submit" id="submitButton"><i style="color: #FFC222" class="far fa-check-square"></i>&nbsp Submit</button>
