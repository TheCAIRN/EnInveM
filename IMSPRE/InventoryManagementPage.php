...
<div class="collapse" id="productAdd">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF']; ?>" method="post">
        <div class="form-group col-12">
            ...
            <select class="form-control mb-4" name="V_Name" placeholder="Enter Vendor Name" required="true">
            ...
            <input class="form-control mb-4" name="P_Price" placeholder="Enter Product Price" required="true"/>

            <b><h5>Product Quantity: &nbsp</h5></b>
            <input class="form-control mb-4" name="P_Quantity" placeholder="Enter Product Count" required="true" type="number"/>
